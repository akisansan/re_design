...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-chat-example.com'
  config.app_name = 'Volt-chat-example'
  config.mailer.from = 'Volt-chat-example <no-reply@volt-chat-example.com>'
  ...
  #
  config.app_secret = '1eTzAnlf1ALmSvn-KJXO7x0TW2jDH3IaEv0S0ZYdwoc8q79YSyLD2upNaAzs9KWenZw'
